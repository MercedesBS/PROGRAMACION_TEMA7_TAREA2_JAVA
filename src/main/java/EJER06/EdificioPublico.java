...
public class EdificioPublico {
    ...
    //Creamos un arraylist de la clase principal Persona llamado personasAccedido donde se creará también este un arraylist.
    static private ArrayList<Persona> personasAccedido=new ArrayList<Persona>();
     ...
     * y solicitamos por teclado los atributos creados. Creamos un objeto con todo añadido, luego
     * añadimos en el arraylist los datos introducidos por teclado y nos mostrará un mensaje.
     */
